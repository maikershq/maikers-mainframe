...
async function fetchConfig() {
  ...
  try {
    ...
    console.log(
      "║         MAINFRAME PROTOCOL CONFIGURATION                  ║"
    );
    console.log(
      "╚═══════════════════════════════════════════════════════════╝\n"
    );
    ...
    console.log(
      "   Create Agent:",
      config.fees.createAgent.toString(),
      "lamports",
      `(${config.fees.createAgent / 1e9} SOL)`
    );
    console.log(
      "   Update Agent Config:",
      config.fees.updateAgentConfig.toString(),
      "lamports",
      `(${config.fees.updateAgentConfig / 1e9} SOL)`
    );
    console.log(
      "   Transfer Agent:",
      config.fees.transferAgent.toString(),
      "lamports",
      `(${config.fees.transferAgent / 1e9} SOL)`
    );
    console.log(
      "   Pause Agent:",
      config.fees.pauseAgent.toString(),
      "lamports"
    );
    console.log(
      "   Close Agent:",
      config.fees.closeAgent.toString(),
      "lamports"
    );
    console.log(
      "   Execute Action:",
      config.fees.executeAction.toString(),
      "lamports"
    );
    console.log("");
    ...
    console.log(
      ...
      `BPS (${config.protocolTreasuryBps / 100}%)`
    );
    console.log("");
    ...
    console.log(
      ...
      `BPS (${config.validatorTreasuryBps / 100}%)`
    );
    console.log("");
    ...
    console.log(
      ...
      `BPS (${config.networkTreasuryBps / 100}%)`
    );
    console.log("");

    console.log("⚙️  PROTOCOL LIMITS");
    console.log(
      "   Max Partner Collections:",
      config.maxPartnerCollections.toString()
    );
    console.log(
      "   Max Affiliate BPS:",
      config.maxAffiliateBps,
      `(${config.maxAffiliateBps / 100}%)`
    );
    console.log("");
    ...
    console.log(
      ...
      config.genesisCollectionMint.toBase58()
    );
    console.log(
      "   Partner Collections Count:",
      config.partnerCollections.length
    );
    console.log("");
    ...
    console.log(
      "║  ✅ PROTOCOL IS INITIALIZED AND OPERATIONAL               ║"
    );
    console.log(
      "╚═══════════════════════════════════════════════════════════╝"
    );
